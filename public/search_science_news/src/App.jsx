    ...
    <div className="relative h-full min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-start min-h-screen text-center px-4 pt-40 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-8xl animate-spin-full">{emoji}</span>
        </div>
        ...
        <div className="flex justify-center w-full max-w-md">
          <input
            type="text"
            placeholder="Search..."
            className="w-full px-4 py-2 border border-gray-300 text-white placeholder-white  bg-opacity-50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={query}
